...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Digite codigo del producto a elminar";
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(48, 130);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(48, 82);
			...
			this->ClientSize = System::Drawing::Size(351, 251);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 StreamWriter^formAuxiliar = gcnew StreamWriter("Productos1Aux.txt");
				 String^Linea2Aux = "";
				 StreamReader^formEliminar = gcnew StreamReader("Productos1.txt");
				 ...
				 textoCompletoAux = File::ReadAllText("Productos1Aux.txt");
				 StreamWriter^clientesdeNuevo = gcnew StreamWriter("Productos1.txt");
				 ...
				 if (sw1 == 0)
				 {
					 MessageBox::Show("Codigo no registrado, por favor verificar");
